...
import { Instagram, Facebook, Twitter, Youtube, Music, MessageCircle, Linkedin, Github, Twitch, MessageSquare } from 'lucide-react';
...
const SocialLinks: React.FC<SocialLinksProps> = ({ socialLinks, color = '#6A0DAD' }) => {
